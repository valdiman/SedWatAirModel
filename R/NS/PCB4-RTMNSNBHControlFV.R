...
{
  Ct <- 145.154 # ng/g PCB 4 sediment concentration. Original value 314.263
  n <- 0.42 # [%] porosity
  ds <- 1540 # [g/L] sediment density
  M <- ds * (1 - n) / n # [g/L]
  Cs0 <- Ct * M # [ng/L]
...
parms <- list(ro = 500, ko = 6, kb = 0.1) # Input
...
# Save plot in folder
ggsave("Output/Plots/RTM/NS/NBH/PCB4ALV_NS_ControlFV2.png", plot = p.4, width = 6,
       height = 5, dpi = 500)
